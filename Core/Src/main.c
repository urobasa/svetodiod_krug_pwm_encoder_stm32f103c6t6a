...
#define HOLD_THRESHOLD 1000    // Время удержания кнопки для перехода в режим standby, мс
#define DOUBLE_CLICK_TIME 300  // Время между кликами для определения двойного нажатия, мс
